...
no arquivo [02-pattern-matching](./02-pattern-matching.exs)
...
Veja o arquivo [03-process-message.exs](./03-process-message.exs)
...
Veja o arquivo [04-process-state.exs](./04-process-state.exs)
...
Veja o arquivo [05-fault-tolerancy.exs](./05-fault-tolerancy.exs)
...
Veja o arquivo [06-observer.exs](./06-observer.exs)
...
Veja o arquivo [07-agent.exs](./07-agent.exs)

## Genserver

Abstração para construção de serviço com estado ou não em processos separados.

Veja o arquivo [08-genserver.exs](./07-genserver.exs)

## Supervisor

Abstração para construção de serviço com estado ou não em processos separados.

Veja o arquivo [09-supervisor.exs](./08-supervisor.exs)
